...
let page1txt1 = "Loot is a multiplayer card game, where each card has a unique effect. "
                ...
                + "by being the last person remaining or "
...
let page2txt4 = "When the round is over, the winning player is given a token. "
                + "The player with the most loot after all the rounds wins the game. "
...
let page2txt8 = "This continues until the round is over."
...
let page8txt1 = "The yellow rectangle outlines the event log. When you click on it, you will see the pop out shown "
                + "below:"
let page8txt2 = "When a new round begins, a new entry is created for it. Everytime an action takes place, such as someone plays "
                + "a card, the turn passes, or someone is out, an event will be put into the respective round log. This "
                + "allows you to keep track of the play, and see who is playing what card on who, as well as what card "
                + "was guessed if applicable. You can shrink an individual round log by clicking the arrow on the right of "
                + "the round number."
